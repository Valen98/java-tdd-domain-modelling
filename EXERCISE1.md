...
|----------------|-------------------------------------------------------------|-------------------------------------|------------------------------------------|--------------------|
| `ShoppingCart` | `CheckPrice(HashMap<Items items, Integer quantity> basket)` | `HashMap<Items items>` | Calculate total price for item in basket | Return total price |
|                |                                                             |                                     |                                          |                    |
...
| Classes        | Method                                                      | Member Variable                        | Scenario                                                | Outcome                               |
|----------------|-------------------------------------------------------------|----------------------------------------|---------------------------------------------------------|---------------------------------------|
| `ShoppingCart` | `GetReciept(HashMap<Items items, Integer quantity> basket)` | `HashMap<Items items>` | Calculate total price of each item in basket and give reciept to customer | Return all the items names and quantity and total price for all items |
